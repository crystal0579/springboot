package com.bysonia.sprisecuritydb;
...
public class Generator {
    ...
    public static void main(String[] args) {
        // 包名
        String packageName = "com.bysonia.sprisecuritydb";
        ...
        generateByTables(serviceNameStartWithI, packageName, "Sonia", "sonia", "personRole");
        generateByTables(serviceNameStartWithI, packageName, "Sonia", "sonia", "role");
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String database, String... tableNames) {
        ...
        dataSourceConfig.setDbType(DbType.MYSQL)
                ...
                .setUsername("root")
                .setPassword("123456")
                .setDriverName("com.mysql.cj.jdbc.Driver");//com.mysql.cj.jdbc.Driver
